...
function abs_process_css($css, $theme) {
    ...
    $css = abs_set_regionwidth($css, $regionwidth);
    ...
    $css = abs_set_customcss($css, $customcss);
 ...
 * @return string
 */
function abs_set_regionwidth($css, $regionwidth) {
 ...
 * @return string
 */
function abs_set_customcss($css, $customcss) {
