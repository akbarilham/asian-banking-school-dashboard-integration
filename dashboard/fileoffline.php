...
<html>
    <head>
        <meta charset="UTF-8">
        <title>CentrinovaLMS | Dashboard</title>
   ...
   // GLOBAL $CFG;
        ...
        ?>
    <body class="skin-blue" style="background-image: url('img/AIP-EID/bg1.png');background-repeat: no-repeat;background-position: center; position:relative; background-size:100% 100%;">

        <div class="form-box" id="login-box" style="opacity: 0.8;">
            <div class="header" style="opacity: 0.8;">AIP-EID LMS Sign in</div>
            <form id='login' action="data_tabel.php" method="post" accept-charset="UTF-8" name="form1">
            ...
            <input type="submit" class="btn bg-blue-aus btn-block" name="Submit" value="Sign me in" style="color:white;"/>
                    ...
                    <p><?php echo '<a href="'.$CFG->wwwroot.'/login/forgot_password.php" style="color:#3c8dbc;">I forgot my password</a>'; ?></p>
                    
                    <?php  echo '<a href="'.$CFG->wwwroot.'/login/signup.php" style="color:#3c8dbc;">Register a new membership</a>'; ?>
                </div>
            </form>
